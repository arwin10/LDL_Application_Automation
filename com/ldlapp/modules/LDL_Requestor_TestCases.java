...
public class LDL_Requestor_TestCases {
	WebDriver driver;
	int success_flag=1;
	Properties p=null;
	...
	public void testCaseExecution() throws Exception{
		...
		//LDLfirstAction();
		//LDLsearchRequestverification("LDLsearchRequestverification");
		LDLHomePageVerification("LDLRequestorHomePageVerification");
		//LDLCreateNewCourseAndOfferingsInstructorLedVerification("LDLCreateNewCourseAndOfferingsInstructorLedVerification");
		//LDLCreateNewCourseAndOfferingsWBTVerification("LDLCreateNewCourseAndOfferingsWBTVerification");
		//LDLCreateNewCourseAndOfferingsVODVerification("LDLCreateNewCourseAndOfferingsVODVerification");
		//LDLCreateNewCourseAndOfferingsEPEVerification("LDLCreateNewCourseAndOfferingsEPEVerification");
		//LDLCreateNewCourseAndOfferingsEPOVerification("LDLCreateNewCourseAndOfferingsEPOVerification");
		//LDLCreateNewCourseAndOfferingsOJTVerification("LDLCreateNewCourseAndOfferingsOJTVerification");
		//LDLCreateNewCourseAndOfferingsINLVerification("LDLCreateNewCourseAndOfferingsINLVerification");
		//LDLCreateNewCourseAndOfferingsVCVerification("LDLCreateNewCourseAndOfferingsVCVerification");
		//LDLCreateNewOtherLASRequestVerification("LDLCreateNewOtherLASRequestVerification");
		//LDLcreateNewOfferingRequestVerification("LDLcreateNewOfferingRequestVerification");
		//LDLUpdateExistingEMSCourseRequestVerification("LDLUpdateExistingEMSCourseRequestVerification");
		//LDLCancelExistingEMSOfferingRequestVerification("LDLCancelExistingEMSOfferingRequestVerification");
		//LDLUpdateExistingEMSOfferingRequestVerification("LDLUpdateExistingEMSOfferingRequestVerification");
		//LDLActionItemsVerification("LDL_Requestor_ActionItems_ReturnedReq_Verification");
		//LDLActionItemsVerification("LDL_Requestor_ActionItems_DraftReq_Verification");
	}
	...
	public void LDLActionItemsVerification(String testCaseName) throws Exception{
			...
			try
			{
				  ...
				  {   
					 ...
					 if(driver.findElement(By.xpath(p.getProperty("requestImmAttLink"))).isDisplayed())
					  { 
						 CUtilities.clickLink(p.getProperty("requestImmAttLink"), driver);
					     Thread.sleep(5000);
					     ...
					     if(driver.findElement(By.xpath(p.getProperty("actionItemsPage"))).isDisplayed())
					     {
				          ...
				          { 
				            ...
				            {   
				               ...
				               if(testCaseName.equalsIgnoreCase("LDL_Requestor_ActionItems_ReturnedReq_Verification"))
				               {if(tdElement.getText().equalsIgnoreCase("Returned"))
				                {   
				                	reqLink.click();
				                	Thread.sleep(2000);
				                	flag=1;
				               ...
				               if(testCaseName.equalsIgnoreCase("LDL_Requestor_ActionItems_DraftReq_Verification"))
				         ...
				         if(driver.findElements(By.xpath(p.getProperty("offeringsSubmitToLASButton"))).size()>0)
				         {   
				        	 System.out.println("Submit To LAS Button Exist.");
				        	  CUtilities.clickButton(p.getProperty("offeringsSubmitToLASButton"), driver);
						      Thread.sleep(2000);
						      CUtilities.clickButton(p.getProperty("submitToLASCancelButton"), driver);
							  Thread.sleep(2000);
				         ...
				         else if(testCaseName.equalsIgnoreCase("LDL_Requestor_ActionItems_DraftReq_Verification"))
				         {  		        	 
							 
				        	 if(driver.findElements(By.xpath(p.getProperty("continueButtonLink"))).size()>0)
				        	 { 
				        		 CUtilities.clickButton(p.getProperty("continueButtonLink"), driver);
				        		 Thread.sleep(5000);
				        		 ...
				        		 if(driver.findElements(By.xpath(p.getProperty("submitToLASButton"))).size()>0)
				        		 { CUtilities.clickButton(p.getProperty("submitToLASButton"), driver);
							      Thread.sleep(2000);
							      CUtilities.clickButton(p.getProperty("submitToLASCancelButton"), driver);
								  Thread.sleep(2000);
								  CUtilities.clickButton(p.getProperty("submitToLASButton"), driver);
								  ...
								  CUtilities.fillTextArea(p.getProperty("LDLCommentsSubmitToLASTextArea"), map.get("OFFERINGS_SPC_INST_LAS").toString(), driver);
							      Thread.sleep(2000);
							      CUtilities.clickButton(p.getProperty("submitToLASButton2"), driver);
								  Thread.sleep(2000);
				        		 }
				        		 else
				        		 {
				        			 success_flag=0;
									 System.out.println("Error Occured:Submit to LAS Button doesn't exist.");
				        		 }
				        	 }
	 ...
	 public void SampleLDLTestCase(String testCaseName) throws Exception{
