...
public class LDL_DE_TestCases {
	...
	public void setUp(String browserName){
    	...
    	moduleRecord=BController.initializeApplication("DE_Module","firstActions",DBUtilities,CUtilities,browserName);
	...
	public void testCaseExecution() throws Exception{
		...
		//LDLfirstAction();
	    //LDLsearchRequestverification("LDL_DE_searchRequestverification");
		//LDLHomePageVerification("LDL_DE_HomePageVerification"); /*Issue with Tab scrolling Because of this Testcase failing. And No data in Action Items Page to verify*/	
		//LDLActionItemsVerification("LDL_DE_ActionItemsVerification");
		//LDLActionItemsVerification("LDL_DE_ActionItems_CancelRequest_Verification"); /**LAS-DE can't cancel a request. **/
		//LDLActionItemsVerification("LDL_DE_ActionItems_SubmitToEMS_Verification");
		//LDLActionItemsVerification("LDL_DE_ActionItems_ReturnRequest_Verification");
		//LDLActionItemsVerification("LDL_DE_ActionItems_AssignRequest_Verification");
		//LDLActionItemsVerification("LDL_DE_ActionItems_SetupComplete_Verification");
		LDLActionItemsVerification("LDL_DE_ActionItems_CompleteRequest_Verification"); /*--Setup Complete Data is taking a lot of time to reflect in the table becuase of which testcase failing.--*/
	}
				 ...
				 if(driver.findElement(By.xpath(p.getProperty("actionItemsPageTCLink"))).isDisplayed())
				  { 
				     ...
				     if(driver.findElement(By.xpath(p.getProperty("actionItemsPage"))).isDisplayed())
				     {
					   ...
					   if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_CompleteRequest_Verification"))
					   { CUtilities.selectFromDropDownbyText(p.getProperty("requestTableRequestStatusDrpDwn"),map.get("REQUEST_STATUS").toString(), driver);
					     Thread.sleep(5000);
			          ...
			          { 
			            ...
			            {   
			               ...
			               if((testCaseName.equalsIgnoreCase("LDL_DE_ActionItemsVerification")||testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_CancelRequest_Verification")||testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_SubmitToEMS_Verification")||testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_ReturnRequest_Verification"))||testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_AssignRequest_Verification"))
			               ...
			               if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_SetupComplete_Verification"))
			         ...
			         else if (testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_SubmitToEMS_Verification"))
			         {  
			         ...
			         else if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_CancelRequest_Verification"))
			         {  		        	 
			         ...
			         else if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_ReturnRequest_Verification"))
			         {  
			         ...
			         else if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_AssignRequest_Verification"))
			         {  
			         ...
			         else if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_SetupComplete_Verification"))
			         {  
			         ...
			         else if(testCaseName.equalsIgnoreCase("LDL_DE_ActionItems_CompleteRequest_Verification"))
			         {
